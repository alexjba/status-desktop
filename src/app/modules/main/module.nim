...
method prepareKeycardManagementModule*[T](self: Module[T]) =
  if self.keycardManagementModule.isNil:
    self.keycardManagementModule = keycard_management_module.newModule[Module[T]](self, self.events, self.keycardServiceV2, self.accountsService, self.walletAccountService, self.privacyService)
