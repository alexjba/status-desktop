...
nim-test-run/test/nim/services_pause_bridge_test.nim: NIM_PARAMS += --passL:"-L$(STATUSQ_LIB_PATH)" --passL:"-lStatusQ"
nim-test-run/test/nim/services_pause_bridge_test.nim: | statusq
