...
if [[ -z "${IN_NIX_SHELL}" ]]; then
    ...
    cp /opt/qt/6.11.0/gcc_64/libexec/QtWebEngineProcess "${APP_DIR}/usr/libexec/"
    ...
    cp /opt/qt/6.11.0/gcc_64/resources/* "${APP_DIR}/usr/libexec/"
    cp -r /opt/qt/6.11.0/gcc_64/translations/qtwebengine_locales "${APP_DIR}/usr/libexec/"
